...
export const captionPages: CaptionPage[] = [
  ...
  {from: 280, to: 369, text: "Follow each sentence and word as natural voices read aloud"},
  ...
  {from: 560, to: 626, text: "Save difficult words for smart review"},
  {from: 675, to: 733, text: "Choose the look and voice that feel right"},
  {from: 790, to: 898, text: "Read pause ask and continue with the new DyslexiaBuddy"},
];
